...
export class DemoMeetingApp implements AudioVideoObserver,
    ...
    initFirebase(): void {
        ...
        const firebaseConfig = <any>{
            apiKey: "AIzaSyBnF6DbPEo5LB2hIOhOzIMNkoJxKZp6lws",
            authDomain: "superset-mock-data.firebaseapp.com",
            databaseURL: "https://superset-mock-data.firebaseio.com",
            projectId: "superset-mock-data",
            storageBucket: "superset-mock-data.appspot.com",
            messagingSenderId: "986737784940",
            appId: "1:986737784940:web:32d1c2fa327f09b8f24049 ",
        };
        firebase.initializeApp(firebaseConfig);
        firebase.auth().signInWithEmailAndPassword('pranjal@greekturtle.com', '58b09e02-984afc5b').catch(function (error) {
            console.error(error);
        });
